...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/CantileverDispImperf.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/CantileverReacImperf.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
...
pattern Plain 1 Linear {
  ...
  load $EndNode 0 0 0 0.00043 0 0;
  }
