...
set ColSecTag 1
	...
	set Es 21000.0;		# Steel Young's Modulus
	set Gs 8077.0;  # Torsional stiffness Modulus
	set matID 1;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/McrDispEndDB80Layer8.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/McrDispMidDB80Layer8.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;	
