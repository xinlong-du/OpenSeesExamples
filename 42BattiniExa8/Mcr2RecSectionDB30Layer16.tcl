...
set ColSecTag 1
	...
	set Es 71.24e6;		# Steel Young's Modulus
	set Gs 27.19e6;  # Torsional stiffness Modulus
	set matID 1;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/Mcr2DispEndDB30Layer16.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/Mcr2DispMidDB30Layer16.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;	
...
pattern Plain 2 Linear {
  # NodeID, Fx, Fy, Fz, Mx, My, Mz
  load $StartNode 0 0 0 0 0 -$M;
  load $EndNode   0 0 0 0 0 $M; 
 }
...
#integrator DisplacementControl $EndNode 2   $Dincr     1  $Dincr -0.01;
