...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/2DispEndFz1.0dispCtrlDB40Layer8.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
integrator DisplacementControl $EndNode 2   $Dincr     1  $Dincr -0.001;
