...
for {set i 1} {$i<102} {incr i 1} {
	node $i [expr -1.0+1.0*$i] 0 0;
}
...
set numIntgrPts 10;	# number of Gauss integration points for nonlinear curvature distribution
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DispEndFz0.001dispCtrlDB100Int10.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
