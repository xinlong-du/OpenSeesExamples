...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/2DispEndFz1.0dispCtrlDB40.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
