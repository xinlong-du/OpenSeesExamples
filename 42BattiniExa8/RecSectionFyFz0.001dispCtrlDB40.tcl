...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DispEndFz0.001dispCtrlDB40.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
