...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/ElasDispEndDB40.out -time -node 41 -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/ElasDispMidDB40.out -time -node 21 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
