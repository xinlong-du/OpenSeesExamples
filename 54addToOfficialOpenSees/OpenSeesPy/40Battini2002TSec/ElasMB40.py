...
# Define RECORDERS ------------------------------------------------------------
recorder('Node', '-file', f'{dataDir}/ElasDispEndMB40.out', '-time', '-node', *[EndNode], '-dof', *[1, 2, 3, 4, 5, 6,], 'disp');
recorder('Node', '-file', f'{dataDir}/ElasDispMidMB40.out', '-time', '-node', *[MidNode], '-dof', *[1, 2, 3, 4, 5, 6,], 'disp');
