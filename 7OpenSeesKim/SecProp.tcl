...
#
#Properties can be calculated by removing comments (in turn) for each section
#
#Written by:
#Rinchen
#PhD student
...
set t 3.0;  #thickness
set r 5.0;  #Inside corner radius
#-------------------------------------------------------
...
#set data [roundCornerTroughInfo $D $B $L $t $r];#channel sections with curved corners rotated by 90 degrees
...
#4)PI-Sections
#set D 150.0; #Depth
#set B 150.0; #Width of flange
#set Bw 50.0; #Clear width between legs
#set tf 3.0; #Thickness of flange
#set tw 3.0; #Thickness of web
#-------------------------------------------------------
#set data [piSectionInfo $D $B $Bw $tf $tw];#Pi-sections 
#==========================================================
#
