...
# define RECORDERS
#-------------------------------------------------------------
recorder Node -file $dir/AsyCB_Nx300dispNoimper.out -time -node $middleNode $startNode $endNode -dof 1 2 3 4 5 6 7 disp;# record displacements at the middle node
recorder Node -file $dir/AsyCB_Nx300reacNoimper.out -time -node $startNode $endNode -dof 1 2 3 4 5 6 7 reaction;
