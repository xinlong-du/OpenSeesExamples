...
# define RECORDERS
#-------------------------------------------------------------
recorder Node -file $dir/AsyCB_Nx300disp.out -time -node $middleNode -dof 1 2 3 4 5 6 7 disp;# record displacements at the middle node
recorder Node -file $dir/AsyCB_Nx300reac.out -time -node $startNode $endNode -dof 1 2 3 4 5 6 7 reaction;
