...
puts "shear center z0 $z0"
puts "shear center y0 $y0"

# define RECORDERS
#-------------------------------------------------------------
recorder Node -file $dir/AsyCB_Nx300dispCanti.out -time -node $endNode -dof 1 2 3 4 5 6 7 disp;# record displacements at the middle node
recorder Node -file $dir/AsyCB_Nx300reacCanti.out -time -node $startNode -dof 1 2 3 4 5 6 7 reaction;
# define initial Perturbation Load
#------------------------------------------------------------- 
pattern Plain 1 Linear {
  # NodeID, Fx, Fy, Fz, Mx, My, Mz, Bx
  load $endNode 0 0 0 48.5 0 0 0;
  }
