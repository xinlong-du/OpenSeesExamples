...
element dispBeamColumn 2 $EndNode $EndLoad $numIntgrPts $ColSecTag $IDColTransf $y0 $z0 -integration Lobatto;
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB1End.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
#recorder Node -file $dataDir/DB2Mid.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Element -file $dataDir/DB1DefoEle1sec1.out -time -ele 1 section 1 deformation;
recorder Element -file $dataDir/DB1DefoEle1sec2.out -time -ele 1 section 2 deformation;
recorder Element -file $dataDir/DB1DefoEle1sec3.out -time -ele 1 section 3 deformation;
recorder Element -file $dataDir/DB1DefoEle1sec4.out -time -ele 1 section 4 deformation;
recorder Element -file $dataDir/DB1DefoEle1sec5.out -time -ele 1 section 5 deformation;
recorder Element -file $dataDir/DB1DefoEle1sec6.out -time -ele 1 section 6 deformation;
recorder Element -file $dataDir/DB1DefoEle1sec7.out -time -ele 1 section 7 deformation;
