...
hold on
plot(ele1Lobatto,DB1curv,'bs--','LineWidth',1.0)
% plot(ele1Lobatto,MB1curv,'r-.','LineWidth',1.0)
plot(ele1Lobatto,MB1curvFromForce,'ro-.','LineWidth',1.0)
...
hold on
plot(ele2Lobatto,DB2curv,'bs--','LineWidth',1.0)
% plot(ele2Lobatto,MB2curv,'ro-.','LineWidth',1.0)
plot(ele2Lobatto,MB2curvFromForce,'ro-.','LineWidth',1.0)
