...
set ColSecTag 1
	...
	set Es 199900.0;		# Steel Young's Modulus
	set nu 0.3;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/E900E1EndIniStre.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/E900E1StaIniStre.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/E900E1MidIniStre.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
...
pattern Plain 1 Linear {
  ...
  load $MiddleNode 0.0 $F 0.0 0.0 0.0 0.0;
  }
