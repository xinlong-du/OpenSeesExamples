...
node 1 0.0    0.0    0.0;
node 2 0.0    1200.0 0.0;
node 3 240.0  1200.0 0.0;
node 4 1200.0 1200.0 0.0;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedLeeFrameInElasMB3.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
test NormDispIncr 1.0e-03 10000; # determine if convergence has been achieved at the end of an iteration step
#algorithm NewtonLineSearch;# use Newton's solution algorithm: updates tangent stiffness at every iteration
algorithm Newton;
#integrator LoadControl 0.1;
#integrator ArcLength 0.1 0.05; #arclength alpha
set Dincr -0.01; #-0.00002
                               #Node,     dof, 1st incr, Jd, min,   max
integrator DisplacementControl $MiddleNode 2   $Dincr     1  $Dincr -0.01;
