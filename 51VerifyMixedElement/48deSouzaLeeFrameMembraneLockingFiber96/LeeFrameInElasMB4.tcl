...
node 4 720.0  1200.0 0.0;
node 5 1200.0 1200.0 0.0;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedLeeFrameInElasMB4.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
