...
hold on
plot(L72exp(:,1),L72exp(:,2),'k--','LineWidth',1.0)
plot(L72shell(:,1),L72shell(:,2),'k-.','LineWidth',1.0)
plot(L72liu(:,1),L72liu(:,2),'k:','LineWidth',1.0)
legend({'DB10','Exp. by Dinis et al. [61]','Shell ele. by Dinis et al. [61]','Beam ele. by Liu et al. [28]'},'FontSize',10)
...
set(gca,'FontSize',10)
xlabel('Axial shortening (mm)','FontSize',10) 
ylabel('Applied force (kN)','FontSize',10)
% save figure
figWidth=3.5;
figHeight=3;
...
hold on
plot(L60exp(:,1),L60exp(:,2),'k--','LineWidth',1.0)
...
hold on
plot(L48Bexp(:,1),L48Bexp(:,2),'k--','LineWidth',1.0)
...
hold on
plot(L48Aexp(:,1),L48Aexp(:,2),'k--','LineWidth',1.0)
plot(L48Aliu(:,1),L48Aliu(:,2),'k:','LineWidth',1.0)
legend({'DB10','Exp. by Dinis et al. [61]','Beam ele. by Liu et al. [28]'},'FontSize',10)
legend('Location','southeast')
xlim([0 6.0])
ylim([0 400])
set(gca,'XTick',(0:1:6))
