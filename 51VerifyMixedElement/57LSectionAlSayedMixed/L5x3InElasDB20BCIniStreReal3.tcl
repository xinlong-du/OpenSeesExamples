...
set ColSecTag 1
	...
	uniaxialMaterial InitStressMaterial 1 $matID -7.0;
	uniaxialMaterial InitStressMaterial 2 $matID -10.0;
	uniaxialMaterial InitStressMaterial 3 $matID -1.0;
	...
	uniaxialMaterial InitStressMaterial 10 $matID -2.5;
	uniaxialMaterial InitStressMaterial 11 $matID -4.0;
	uniaxialMaterial InitStressMaterial 12 $matID -5.5;
	uniaxialMaterial InitStressMaterial 13 $matID -8.5;
	uniaxialMaterial InitStressMaterial 14 $matID -0.8;
	uniaxialMaterial InitStressMaterial 15 $matID -0.5;
	uniaxialMaterial InitStressMaterial 16 $matID 0.0;
	uniaxialMaterial InitStressMaterial 17 $matID 4.6;
	uniaxialMaterial InitStressMaterial 18 $matID 10.2;
	uniaxialMaterial InitStressMaterial 19 $matID 2.7;
	uniaxialMaterial InitStressMaterial 20 $matID -0.5;
	uniaxialMaterial InitStressMaterial 21 $matID -4.6;
	uniaxialMaterial InitStressMaterial 22 $matID -8.3;
	uniaxialMaterial InitStressMaterial 23 $matID -10.2;
	uniaxialMaterial InitStressMaterial 24 $matID -12.1;
	uniaxialMaterial InitStressMaterial 25 $matID -13.0;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/L5x3InElasDB20BCIniStreEndReal3.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/L5x3InElasDB20BCIniStreSatReal3.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/L5x3InElasDB20BCIniStreMidReal3.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
