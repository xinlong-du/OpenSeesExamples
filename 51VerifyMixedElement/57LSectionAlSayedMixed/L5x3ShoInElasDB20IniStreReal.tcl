...
set ColSecTag 1
	...
	uniaxialMaterial InitStressMaterial 1 $matID -8.95;
	uniaxialMaterial InitStressMaterial 2 $matID -10.5;
	...
	uniaxialMaterial InitStressMaterial 6 $matID 8.0;
	uniaxialMaterial InitStressMaterial 7 $matID 7.5;
	uniaxialMaterial InitStressMaterial 8 $matID 9.0;
	uniaxialMaterial InitStressMaterial 9 $matID 2.0;
	...
	uniaxialMaterial InitStressMaterial 14 $matID -2.8;
	uniaxialMaterial InitStressMaterial 15 $matID -1.9;
	uniaxialMaterial InitStressMaterial 16 $matID 0.0;
	uniaxialMaterial InitStressMaterial 17 $matID 5.6;
	uniaxialMaterial InitStressMaterial 18 $matID 12.2;
	uniaxialMaterial InitStressMaterial 19 $matID 4.7;
	uniaxialMaterial InitStressMaterial 20 $matID -1.9;
	uniaxialMaterial InitStressMaterial 21 $matID -5.6;
	uniaxialMaterial InitStressMaterial 22 $matID -10.3;
	uniaxialMaterial InitStressMaterial 23 $matID -12.2;
	uniaxialMaterial InitStressMaterial 24 $matID -13.1;
	uniaxialMaterial InitStressMaterial 25 $matID -15.0;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/L5x3ShoDB20IniStreEndReal.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/L5x3ShoDB20IniStreSatReal.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/L5x3ShoDB20IniStreMidReal.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
