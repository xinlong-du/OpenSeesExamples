...
for {set i 1} {$i<22} {incr i 1} {
	node $i [expr -1.432182+1.432182*$i] 0 0;
}
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/L5x3ShoDB20IniStreEndMeasure.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/L5x3ShoDB20IniStreSatMeasure.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/L5x3ShoDB20IniStreMidMeasure.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
