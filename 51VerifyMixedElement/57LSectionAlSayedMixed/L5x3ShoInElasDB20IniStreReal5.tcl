...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/L5x3ShoDB20IniStreEndReal5.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/L5x3ShoDB20IniStreSatReal5.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/L5x3ShoDB20IniStreMidReal5.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
