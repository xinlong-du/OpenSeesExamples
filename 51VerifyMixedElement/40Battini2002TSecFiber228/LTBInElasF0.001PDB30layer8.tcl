...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/LTBInElasDispEndF0001PDB30layer8.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/LTBInElasDispMidF0001PDB30layer8.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
pattern Plain 2 Linear {
  ...
  load $EndNode 0 $F 0 0 0 0;
  load $EndNode 0 0 $P 0 0 0; 
 }
...
integrator DisplacementControl $EndNode 3   $Dincr     1  $Dincr 0.1;
