...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/FTBDispEndF0001PDB8.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/FTBDispMidF0001PDB8.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
