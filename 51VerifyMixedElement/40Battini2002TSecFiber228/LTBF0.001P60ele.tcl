...
for {set i 1} {$i<62} {incr i 1} {
	node $i [expr -20.0+20.0*$i] 0 0;
}
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/LTBDispEndF0001P60ele.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/LTBDispMidF0001P60ele.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
