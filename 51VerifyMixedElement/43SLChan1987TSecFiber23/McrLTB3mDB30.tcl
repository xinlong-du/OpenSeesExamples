...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedMcrLTBDispEnd3mDB30Fy50.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/mixedMcrLTBDispMid3mDB30Fy50.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
