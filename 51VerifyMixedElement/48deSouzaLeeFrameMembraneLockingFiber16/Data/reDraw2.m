...
% plot(-ElasDB4(:,3)/10,ElasDB4(:,1),'k:','Marker','+',...
%     'MarkerSize',5,'MarkerIndices',(25:100:1267),'LineWidth',0.8)
plot(-ElasDB4(:,3)/10,ElasDB4(:,1),'k-.','LineWidth',0.8)
plot(-ElasDB5(:,3)/10,ElasDB5(:,1),'k--','Marker','.',...
    'MarkerSize',12,'MarkerIndices',(1:100:1700),'LineWidth',0.8)
% plot(-ElasDB10(:,3)/10,ElasDB10(:,1),'k-','LineWidth',0.5)
% plot(-mixedElasMB3(:,3)/10,mixedElasMB3(:,1),'r-.','LineWidth',0.5)
% plot(-mixedElasMB4(:,3)/10,mixedElasMB4(:,1),'k:','Marker','*',...
%     'MarkerSize',5,'MarkerIndices',(75:100:1203),'LineWidth',0.8)
plot(-mixedElasMB4(:,3)/10,mixedElasMB4(:,1),'k:','LineWidth',0.8)
plot(-mixedElasMB5(:,3)/10,mixedElasMB5(:,1),'k-','Marker','x',...
    'MarkerSize',5,'MarkerIndices',(50:100:1700),'LineWidth',0.8)
% plot(-mixedElasMB10(:,3)/10,mixedElasMB10(:,1),'r-','LineWidth',0.5)

legend({'de Souza','DB4','DB5','MB4','MB5'},'FontSize',10)
...
plot(-InElasDB4(1:end,3)/10,InElasDB4(1:end,1),'k-.','LineWidth',0.8)
plot(-InElasDB5(1:end,3)/10,InElasDB5(1:end,1),'k--','Marker','.',...
    'MarkerSize',12,'MarkerIndices',[(1:80:597) 596],'LineWidth',0.8)
...
plot(-mixedInElasMB4(1:end,3)/10,mixedInElasMB4(1:end,1),'k:','LineWidth',1)
plot(-mixedInElasMB5(1:end,3)/10,mixedInElasMB5(1:end,1),'k-','Marker','x',...
    'MarkerSize',5,'MarkerIndices',(40:80:1000),'LineWidth',0.8)
