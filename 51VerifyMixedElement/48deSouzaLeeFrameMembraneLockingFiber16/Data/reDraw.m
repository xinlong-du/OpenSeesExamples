...
hfig=figure;
plot(deSouzaElas(:,1),deSouzaElas(:,2),'ko','LineWidth',0.5)
hold on
plot(-ElasDB3(:,3)/10,ElasDB3(:,1),'k-.','LineWidth',0.5)
plot(-ElasDB4(:,3)/10,ElasDB4(:,1),'k:','LineWidth',0.5)
plot(-ElasDB5(:,3)/10,ElasDB5(:,1),'k--','LineWidth',0.5)
plot(-ElasDB10(:,3)/10,ElasDB10(:,1),'k-','LineWidth',0.5)
plot(-mixedElasMB3(:,3)/10,mixedElasMB3(:,1),'r-.','LineWidth',0.5)
plot(-mixedElasMB4(:,3)/10,mixedElasMB4(:,1),'r:','LineWidth',0.5)
plot(-mixedElasMB5(:,3)/10,mixedElasMB5(:,1),'r--','LineWidth',0.5)
plot(-mixedElasMB10(:,3)/10,mixedElasMB10(:,1),'r-','LineWidth',0.5)

legend({'de Souza','DB3-NoLocking','DB4-NoLocking','DB5-NoLocking','DB10-NoLocking',...
    'MB3','MB4','MB5','MB10'},'FontSize',5)
...
hfig=figure;
plot(deSouzaInElas(:,1),deSouzaInElas(:,2),'ko','LineWidth',0.5)
hold on
plot(-InElasDB3(1:end,3)/10,InElasDB3(1:end,1),'k-.','LineWidth',0.5)
plot(-InElasDB4(1:end,3)/10,InElasDB4(1:end,1),'k:','LineWidth',0.5)
plot(-InElasDB5(1:end,3)/10,InElasDB5(1:end,1),'k--','LineWidth',0.5)
...
plot(-mixedInElasMB4(1:end,3)/10,mixedInElasMB4(1:end,1),'r:','LineWidth',0.5)
plot(-mixedInElasMB5(1:end,3)/10,mixedInElasMB5(1:end,1),'r--','LineWidth',0.5)
