...
#set SecTagTorsion 70
	...
	set Es 193050.0;		# Steel Young's Modulus
	set nu 0.3;
	set Gs [expr $Es/2./[expr 1+$nu]];  # Torsional stiffness Modulus
	set matID 1
	uniaxialMaterial Elastic $matID $Es;
	set J 11030.77083333;
	set GJ [expr $Gs*$J];
	set z0 16.19019803;
	set y0 -17.51893393;
    source Lsection.tcl;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/MB5GP5.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
#recorder Node -file $dataDir/MB6.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
...
integrator DisplacementControl $EndNode 1   $Dincr     1  $Dincr -1.0;
