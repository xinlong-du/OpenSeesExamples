...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedCantileverDispM11000DB20layer2t0794-.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
