...
hold on
plot(ele1Lobatto,DB1curv,'ks--','LineWidth',1.0)
% plot(ele1Lobatto,MB1curv,'r-.','LineWidth',1.0)
plot(ele1Lobatto,MB1curvFromForce,'ko-.','LineWidth',1.0)
...
hold on
plot(ele2Lobatto,DB2curv,'ks--','LineWidth',1.0)
% plot(ele2Lobatto,MB2curv,'ro-.','LineWidth',1.0)
plot(ele2Lobatto,MB2curvFromForce,'ko-.','LineWidth',1.0)
