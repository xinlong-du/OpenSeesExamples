...
set ColSecTag 1
	...
	set Es 9445.0;		# Steel Young's Modulus
	set Gs 3766.0;  # Torsional stiffness Modulus
	set matID 1;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedLTBDispEndL65DB40.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/mixedLTBDispMidL65DB40.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
