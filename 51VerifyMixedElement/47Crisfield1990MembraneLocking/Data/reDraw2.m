...
plot(DispEnd8Layer10ele(11:end,4),DispEnd8Layer10ele(11:end,1),'k-','Marker','x',...
    'MarkerSize',5,'MarkerIndices',(400:800:15000),'LineWidth',1)
hold on
plot(DispEnd8Layer20ele(11:end,4),DispEnd8Layer20ele(11:end,1),'k--','Marker','+',...
    'MarkerSize',5,'MarkerIndices',(400:800:15000),'LineWidth',1)
plot(DispEnd8Layer40ele(11:end,4),DispEnd8Layer40ele(11:end,1),'k-.','Marker','*',...
    'MarkerSize',5,'MarkerIndices',(400:800:15000),'LineWidth',1)
...
plot(mixedDispEnd8Layer10ele(11:end,4),mixedDispEnd8Layer10ele(11:end,1),'r-','LineWidth',1)
plot(mixedDispEnd8Layer20ele(11:end,4),mixedDispEnd8Layer20ele(11:end,1),'r--','LineWidth',1)
plot(mixedDispEnd8Layer40ele(11:end,4),mixedDispEnd8Layer40ele(11:end,1),'r-.','LineWidth',1)
...
legend({'DB10','DB20','DB40',...
    'MB10','MB20','MB40','Alemdar','Crisfield','Simo and Vu-Quoc'},'FontSize',10)
