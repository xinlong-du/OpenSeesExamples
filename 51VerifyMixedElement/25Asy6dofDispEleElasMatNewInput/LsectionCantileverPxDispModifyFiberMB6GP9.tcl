...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedCantileverDispModifyFiber2layerMB6GP9.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/mixedCantileverReacModifyFIber2layerMB6GP9.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
