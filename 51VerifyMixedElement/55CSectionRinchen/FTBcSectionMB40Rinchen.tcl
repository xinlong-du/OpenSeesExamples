...
set nodeI $i
set nodeJ [expr $i+1]
element mixedBeamColumn $elemID $nodeI $nodeJ $numIntgrPts $BeamSecTagFiber $IDColTransf -shearCenter $y0 $z0;	
} 

# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/MB40EndRinchen.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/MB40MidRInchen.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
pattern Plain 1 Linear {
  ...
  load $MiddleNode 0 0 0 485.0 0 0;
  }
