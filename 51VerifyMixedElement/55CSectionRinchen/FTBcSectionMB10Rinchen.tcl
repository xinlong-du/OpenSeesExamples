...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/MB10EndRinchen.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/MB10MidRInchen.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
pattern Plain 1 Linear {
  ...
  load $MiddleNode 0 4.85 0 0 0 0;
  }
