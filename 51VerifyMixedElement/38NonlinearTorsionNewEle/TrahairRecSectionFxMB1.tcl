...
for {set i 1} {$i<3} {incr i 1} {
	node $i [expr -1000.0+1000.0*$i] 0 0;
}
...
source TrahairRecSection4Layer.tcl;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/TrahairMB1DispEnd.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
integrator DisplacementControl $EndNode 4   $Dincr     1  $Dincr 0.001;
