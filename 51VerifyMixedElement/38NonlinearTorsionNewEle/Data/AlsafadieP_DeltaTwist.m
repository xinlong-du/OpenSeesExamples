...
% plot(DispEndMxDB1(:,5),10000*DispEndMxDB1(:,1),'k-','LineWidth',1)
% plot(DispEndMxMB1(:,5),10000*DispEndMxMB1(:,1),'r-','LineWidth',1)
% plot(DispEndMxDB2(:,5),10000*DispEndMxDB2(:,1),'k-','LineWidth',1)
% plot(DispEndMxMB2(:,5),10000*DispEndMxMB2(:,1),'r-','LineWidth',1)
...
% legend({'Trahair-nonlinear','Trahair-linear','DB1','MB1','DB2','MB2','DB4','MB4'},'FontSize',10)
