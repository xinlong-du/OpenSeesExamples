...
set ColSecTag 1
	...
	set Es 2100000;		# Steel Young's Modulus
	set Gs 787500;  # Torsional stiffness Modulus
	set matID 1;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedDispEnd.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
