...
for {set i 1} {$i<22} {incr i 1} {
	node $i [expr -46.736+46.736*$i] 0 0;
}
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedDispM4338ele20.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
