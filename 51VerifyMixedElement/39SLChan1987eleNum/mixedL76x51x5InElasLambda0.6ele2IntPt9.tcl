...
for {set i 1} {$i<4} {incr i 1} {
	node $i [expr -269.64185+269.64185*$i] 0 0;
}
...
set numIntgrPts 9;	# number of Gauss integration points for nonlinear curvature distribution
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedL76x51x5InElasLambda06EndMB2IntPt9.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/mixedL76x51x5InElasLambda06SatMB2IntPt9.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/mixedL76x51x5InElasLambda06MidMB2IntPt9.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
