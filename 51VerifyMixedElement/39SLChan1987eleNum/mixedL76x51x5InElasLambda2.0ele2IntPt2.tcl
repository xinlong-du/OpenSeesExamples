...
for {set i 1} {$i<4} {incr i 1} {
	node $i [expr -898.806+898.806*$i] 0 0;
}
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedL76x51x5InElasLambda20EndMB2IntPt2.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/mixedL76x51x5InElasLambda20SatMB2IntPt2.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/mixedL76x51x5InElasLambda20MidMB2IntPt2.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
