...
for {set i 1} {$i<12} {incr i 1} {
	node $i [expr -93.472+93.472*$i] 0 0;
}
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixedCantileverDispM11000DB2layer2t0794.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
