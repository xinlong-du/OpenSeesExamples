...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/L76x51x5Lambda04End.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/L76x51x5Lambda04Sat.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
recorder Node -file $dataDir/L76x51x5Lambda04Mid.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
