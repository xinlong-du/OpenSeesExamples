...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/L76x51x5InElasLambda06EndDB3.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/L76x51x5InElasLambda06SatDB3.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/L76x51x5InElasLambda06MidDB3.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
...
integrator DisplacementControl $StartNode 1   $Dincr     1  $Dincr 0.0001;
