...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/zDB20LsectionEqualLegL4ConcentPerturb.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/zDB20LsectionSimpDispL4MConcentPerturb.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
