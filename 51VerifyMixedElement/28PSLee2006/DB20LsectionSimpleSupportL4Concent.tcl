...
geomTransf $ColTransfType  $IDColTransf 0 0 1 -jntOffset 0.0 -0.01843470 0.00902576 0.0 -0.01843470 0.00902576;	#define geometric transformation: performs a corotational geometric transformation
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB20LsectionSimpDispL4Concent.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
