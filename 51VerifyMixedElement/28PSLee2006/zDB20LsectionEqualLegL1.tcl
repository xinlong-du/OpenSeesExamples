...
set ColSecTag 1
	...
	set Fy 250e6;
	set Es 2e11;		# Steel Young's Modulus
	set nu 0.3;
...
geomTransf $ColTransfType  $IDColTransf 0 0 1 -jntOffset 0.0 -0.02121320 0.0 0.0 -0.02121320 0.0;	#define geometric transformation: performs a corotational geometric transformation
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/zDB20LsectionEqualLegL1.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
test NormDispIncr 1.0e-05 5000; # determine if convergence has been achieved at the end of an iteration step
#algorithm NewtonLineSearch;# use Newton's solution algorithm: updates tangent stiffness at every iteration
algorithm Newton;
set Dincr -0.000004; #-0.00002
#integrator LoadControl 0.0001
#integrator ArcLength 0.005 1.0; #arclength alpha
                               #Node,  dof, 1st incr, Jd, min,   max
integrator DisplacementControl $EndNode 1   $Dincr     1  $Dincr -0.000004;
