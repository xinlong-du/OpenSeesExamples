...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/LsectionSimpDispL4.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/LsectionSimpDispL4M.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
recorder Node -file $dataDir/LsectionSimpReacL4.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
...
test NormDispIncr 1.0e-06 5000; # determine if convergence has been achieved at the end of an iteration step
#algorithm NewtonLineSearch;# use Newton's solution algorithm: updates tangent stiffness at every iteration
algorithm Newton;
set Dincr -0.0000001; #-0.00002
#integrator LoadControl 0.0001
#integrator ArcLength 0.005 1.0; #arclength alpha
                               #Node,  dof, 1st incr, Jd, min,   max
integrator DisplacementControl $EndNode 1   $Dincr     1  $Dincr -0.00001;
analysis Static	;# define type of analysis static or transient
variable algorithmTypeStatic Newton
set ok [analyze 800000];
puts "Finished"
#--------------------------------------------------------------------------------
