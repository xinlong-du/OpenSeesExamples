...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/MB10LsectionSimpDispL4.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
#recorder Node -file $dataDir/MB10LsectionSimpDispL4M.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
#recorder Node -file $dataDir/MB10LsectionSimpReacL4.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
