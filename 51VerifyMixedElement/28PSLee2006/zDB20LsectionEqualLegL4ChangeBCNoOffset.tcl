...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/zDB20LsectionEqualLegL4ChangeBCNoOffset.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/zDB20LsectionSimpDispL4MChangeBCNoOffset.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
...
pattern Plain 2 Linear {
  ...
  load $StartNode $N 0 0 0 0 [expr -0.02121320*$N];
   load $EndNode -$N 0 0 0 0 [expr 0.02121320*$N]; 
 }
