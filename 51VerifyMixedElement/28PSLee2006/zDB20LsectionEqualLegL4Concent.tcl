...
geomTransf $ColTransfType  $IDColTransf 0 0 1 -jntOffset 0.0 -0.01737643 0.0 0.0 -0.01737643 0.0;	#define geometric transformation: performs a corotational geometric transformation
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/zDB20LsectionEqualLegL4Concent.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/zDB20LsectionSimpDispL4MConcent.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
