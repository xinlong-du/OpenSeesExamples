...
for {set i 1} {$i<22} {incr i 1} {
	node $i [expr -3.222571+3.222571*$i] 0 0;
}
...
set ColSecTag 1
	...
	uniaxialMaterial InitStressMaterial 1 $matID -13.6;
	uniaxialMaterial InitStressMaterial 2 $matID -7.5;
	uniaxialMaterial InitStressMaterial 3 $matID -2.0;
	uniaxialMaterial InitStressMaterial 4 $matID 9.0;
	uniaxialMaterial InitStressMaterial 5 $matID 10.5;
	uniaxialMaterial InitStressMaterial 6 $matID 7.5;
	uniaxialMaterial InitStressMaterial 7 $matID 6.0;
	uniaxialMaterial InitStressMaterial 8 $matID 6.0;
	uniaxialMaterial InitStressMaterial 9 $matID -1.0;
	uniaxialMaterial InitStressMaterial 10 $matID -9.0;
	uniaxialMaterial InitStressMaterial 11 $matID -9.5;
	uniaxialMaterial InitStressMaterial 12 $matID -13.5;
	uniaxialMaterial InitStressMaterial 13 $matID -15.0;
	uniaxialMaterial InitStressMaterial 14 $matID -10.3;
	uniaxialMaterial InitStressMaterial 15 $matID -9.4;
	uniaxialMaterial InitStressMaterial 16 $matID -5.6;
	uniaxialMaterial InitStressMaterial 17 $matID 0.8;
	uniaxialMaterial InitStressMaterial 18 $matID 7.5;
	uniaxialMaterial InitStressMaterial 19 $matID 1.9;
	uniaxialMaterial InitStressMaterial 20 $matID -3.75;
	uniaxialMaterial InitStressMaterial 21 $matID -7.5;
	uniaxialMaterial InitStressMaterial 22 $matID -10.3;
	uniaxialMaterial InitStressMaterial 23 $matID -10.5;
	uniaxialMaterial InitStressMaterial 24 $matID -11.25;
	uniaxialMaterial InitStressMaterial 25 $matID -12.2;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/L5x3MidDB20IniStreEndMeasure.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/L5x3MidDB20IniStreSatMeasure.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/L5x3MidDB20IniStreMidMeasure.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
