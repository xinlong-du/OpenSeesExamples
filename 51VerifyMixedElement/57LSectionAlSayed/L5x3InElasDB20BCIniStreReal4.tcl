...
set ColSecTag 1
	...
	uniaxialMaterial InitStressMaterial 4 $matID 9.5;
	uniaxialMaterial InitStressMaterial 5 $matID 10.0;
	uniaxialMaterial InitStressMaterial 6 $matID 8.0;
	uniaxialMaterial InitStressMaterial 7 $matID 8.0;
	uniaxialMaterial InitStressMaterial 8 $matID 8.0;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/L5x3InElasDB20BCIniStreEndReal4.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/L5x3InElasDB20BCIniStreSatReal4.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/L5x3InElasDB20BCIniStreMidReal4.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
