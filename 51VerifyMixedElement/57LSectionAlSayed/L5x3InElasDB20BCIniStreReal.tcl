...
set ColSecTag 1
	...
	uniaxialMaterial InitStressMaterial 4 $matID 10.5;
	uniaxialMaterial InitStressMaterial 5 $matID 11.0;
	uniaxialMaterial InitStressMaterial 6 $matID 9.0;
	uniaxialMaterial InitStressMaterial 7 $matID 9.0;
	uniaxialMaterial InitStressMaterial 8 $matID 9.0;
	uniaxialMaterial InitStressMaterial 9 $matID 3.0;
	...
	uniaxialMaterial InitStressMaterial 15 $matID -2.0;
	uniaxialMaterial InitStressMaterial 16 $matID 0.0;
	uniaxialMaterial InitStressMaterial 17 $matID 6.6;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/L5x3InElasDB20BCIniStreEndReal.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/L5x3InElasDB20BCIniStreSatReal.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/L5x3InElasDB20BCIniStreMidReal.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
