...
# define RECORDERS
#-------------------------------------------------------------
recorder Node -file $dir/ElasSimpCB_Nmid.out -time -node $middleNode -dof 1 2 3 4 5 6 disp;# record displacements at the middle node
recorder Node -file $dir/ElasSimpCB_Nsta.out -time -node $startNode -dof 1 2 3 4 5 6 disp;
