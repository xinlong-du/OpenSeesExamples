...
# DO 1ST ANALYSIS--------------------------------------------------------------------------
recorder('Node', '-file', f'{dataDir}/sinLinDisp1.out', '-time', '-node', *[EndNode], '-dof', *[1, 2, 3, 4, 5, 6,], 'disp');
recorder('Node', '-file', f'{dataDir}/sinLinReac1.out', '-time', '-node', *[StartNode], '-dof', *[1, 2, 3, 4, 5, 6,], 'reaction');
...
# DO 2ND ANALYSIS
# -----------------------------
recorder('Node', '-file', f'{dataDir}/sinLinDisp2.out', '-time', '-node', *[EndNode], '-dof', *[1, 2, 3, 4, 5, 6,], 'disp');
recorder('Node', '-file', f'{dataDir}/sinLinReac2.out', '-time', '-node', *[StartNode], '-dof', *[1, 2, 3, 4, 5, 6,], 'reaction');
#------------------------------------------------------------- 
N = 15.0;
timeSeries('Linear',2);
pattern('Plain', 2, 2);
