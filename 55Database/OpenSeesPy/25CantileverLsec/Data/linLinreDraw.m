...
Disp1=load('linLinDisp1.out');
Reac1=load('linLinReac1.out');
Disp2=load('linLinDisp2.out');
Reac2=load('linLinReac2.out');
...
plot(-Disp2(:,2),Reac2(:,2),'r-','LineWidth',1)
plot(-Disp2(:,3),Reac2(:,2),'r--','LineWidth',1)
hold off
% legend({'Alsafadie-u','Alsafadie-v','DB6-u','DB6-v','DB6-u,1st step','DB6-v,1st step'},'FontSize',8)
legend({'Alsafadie-u','Alsafadie-v','DB6-u,1st step','DB6-v,1st step',...
