...
# recorder('Node', '-file', f'{dataDir}/sinLinDisp1.out', '-time', '-node', *[2], '-dof', *[1], 'disp');
# recorder('Node', '-file', f'{dataDir}/sinLinReac1.out', '-time', '-node', *[1], '-dof', *[1], 'reaction');
...
# recorder('Node', '-file', f'{dataDir}/sinLinDisp2.out', '-time', '-node', *[2], '-dof', *[1], 'disp');
# recorder('Node', '-file', f'{dataDir}/sinLinReac2.out', '-time', '-node', *[1], '-dof', *[1], 'reaction');
...
# plot results-----------------------------------------------------------------
fig = plt.figure()
Disp1=np.loadtxt(f'{dataDir}/sinLinDisp1.out')
Reac1=np.loadtxt(f'{dataDir}/sinLinReac1.out')
plt.plot(Disp1[:,1],-Reac1[:,1])
plt.xlim(-0.4,0.4)
plt.ylim(-400,400)
plt.grid()
fig = plt.figure()
Disp2=np.loadtxt(f'{dataDir}/sinLinDisp2.out')
Reac2=np.loadtxt(f'{dataDir}/sinLinReac2.out')
