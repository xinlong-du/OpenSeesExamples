...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/InElasDispEndDB40stp1.out -time -node 41 -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/InElasDispMidDB40stp1.out -time -node 21 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
# 2ND ANALYSIS -------------------------------------------------------------
recorder Node -file $dataDir/InElasDispEndDB40stp2.out -time -node 41 -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/InElasDispMidDB40stp2.out -time -node 21 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
#recorder Node -file $dataDir/CantileverReac.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
