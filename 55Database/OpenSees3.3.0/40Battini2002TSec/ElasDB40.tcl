...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/ElasDispEndDB40stp1.out -time -node 41 -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/ElasDispMidDB40stp1.out -time -node 21 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
# define 1ST ANALYSIS PARAMETERS-----------------------------------------------
...
# define 2ND ANALYSIS PARAMETERS----------------------------------------------------------
recorder Node -file $dataDir/ElasDispEndDB40stp2.out -time -node 41 -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/ElasDispMidDB40stp2.out -time -node 21 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
