...
# define 1st ANALYSIS-------------------------------------------------------------------------------------------
recorder Node -file $dataDir/dispDBAsym5stp1.out -time -node 6 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
# define 2nd ANALYSIS-------------------------------------------------------------------------------------------
recorder Node -file $dataDir/dispDBAsym5stp2.out -time -node 6 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
