...
set Jrig 2.16;
set Arig 18.0;
set Iz 1350.0;		# moment of Inertia
set Iy 0.54;		# moment of Inertia
...
# define 1st ANALYSIS-------------------------------------------------------------------------------------------
recorder Node -file $dataDir/dispEB5Linearstp1.out -time -node 6 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
# define 2nd ANALYSIS-------------------------------------------------------------------------------------------
recorder Node -file $dataDir/dispEB5Linearstp2.out -time -node 6 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
