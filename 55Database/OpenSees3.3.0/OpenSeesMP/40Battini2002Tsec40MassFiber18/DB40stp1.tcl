...
if {$pid == 0} {
# define 1ST ANALYSIS----------------------------------------------------------------
recorder Node -file $dataDir/jobs2fact250DB40stp1.out.$pid -time -node $EndCentroid -dof 1 2 3 4 5 6 disp;
...
analyze 1000 0.001;
puts "jobs2: Done 1st analysis of pid 0"
...
# define 1ST ANALYSIS----------------------------------------------------------------
# Define RECORDERS ------------------------------------------------------------------
recorder Node -file $dataDir/jobs2fact1000DB40stp1.out.$pid -time -node $EndCentroid -dof 1 2 3 4 5 6 disp;
DisplayModel3D DeformedShape;	 # options: DeformedShape NodeNumbers ModeShape
...
#analyze 34300000 0.0000001;					# Central Difference
analyze 1000 0.001;
puts "jobs2: Done 1st analysis of pid 1"
