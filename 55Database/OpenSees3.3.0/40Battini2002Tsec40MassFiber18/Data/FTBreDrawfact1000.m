clear;clc;
DB40=load('DB40.out');
DB40stp1=load('fact1000DB40stp1.out');
DB40stp2=load('fact1000DB40stp2.out');
...
plot(DB40stp1(:,1),DB40stp1(:,2),'b--','LineWidth',1.5)
% plot(DB40stp2(:,1),DB40stp2(:,2),'g-.','LineWidth',1.5)
...
grid on
legend({'Battini','Abaqus solid','DB40','DB40stp1','DB40stp2'},'FontSize',10)
...
plot(DB40stp1(:,1),DB40stp1(:,3),'b--','LineWidth',1.5)
% plot(DB40stp2(:,1),DB40stp2(:,3),'g-.','LineWidth',1.5)
xlabel('t (s)','FontSize',10) 
...
plot(DB40stp1(:,1),DB40stp1(:,4),'b--','LineWidth',1.5)
% plot(DB40stp2(:,1),DB40stp2(:,4),'g-.','LineWidth',1.5)
xlabel('t (s)','FontSize',10) 
...
% plot(DB40stp2(:,1),DB40stp2(:,4),'k--','LineWidth',0.8)
% 
% xlabel('t (s)','FontSize',10) 
% ylabel('Displacement Uz (m)','FontSize',10)
% xlim([0 2])
