...
# Define RECORDERS ------------------------------------------------------------------
recorder Node -file $dataDir/fact1000DB40stp1.out -time -node $EndCentroid -dof 1 2 3 4 5 6 disp;
...
pattern Plain 3 $WindSeriesA -fact 1000.0 {
...
# define 2ND ANALYSIS----------------------------------------------------------------
recorder Node -file $dataDir/fact1000DB40stp2.out -time -node $EndCentroid -dof 1 2 3 4 5 6 disp;
DisplayModel3D DeformedShape;	 # options: DeformedShape NodeNumbers ModeShape
