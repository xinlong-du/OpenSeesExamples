...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/Lsection2CantileverDispPz.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/Lsection2CantileverReacPz.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
