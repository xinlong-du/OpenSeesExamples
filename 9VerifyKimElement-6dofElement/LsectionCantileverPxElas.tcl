...
if {$SectionType == "Elastic"} {
	...
	set Gs [expr $Es/2./[expr 1+$nu]];  # Torsional stiffness Modulus
	set matIDhard 1;
	uniaxialMaterial Elastic $matIDhard $Es;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/CantileverDispElas.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/CantileverReacElas.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
