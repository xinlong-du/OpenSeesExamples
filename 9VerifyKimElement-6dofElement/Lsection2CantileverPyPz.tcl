...
if {$SectionType == "Elastic"} {
	...
	Lsection2  $ColSecTagFiber $matIDhard $a $b $t1 $t2 $nfa $nfb $nft1 $nft2
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/Lsection2CantileverDispPyPz.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/Lsection2CantileverReacPyPz.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
