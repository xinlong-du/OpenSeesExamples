...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/LsectionSimpDispL0.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/LsectionSimpReacL0.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
recorder Node -file $dataDir/LsectionSimpDispL0M.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
