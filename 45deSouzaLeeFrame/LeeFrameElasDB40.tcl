...
for {set i 1} {$i<22} {incr i 1} {
	node $i 0.0 [expr -60.0+60.0*$i] 0.0;
}
for {set i 22} {$i<42} {incr i 1} {
	node $i [expr 60.0*($i-21)] 1200.0 0.0;
}
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/LeeFrameElasDB40.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
integrator ArcLength 8.0 0.1; #arclength alpha
