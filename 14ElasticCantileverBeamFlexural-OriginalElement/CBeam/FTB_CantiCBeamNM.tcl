...
# material properties:
	...
	set Iz 1340000;		# moment of Inertia
	set Iy 582000;		# moment of Inertia
	set yc 0; #y coord of centroid w.r.t. shear center
	set zc 63.46; #z coord of centroid w.r.t. shear center
	#set z0 -63.46;
	#set y0 0.0;
    #set oC 0.0;
    #set betaZ 0;
...
# define RECORDERS
#-------------------------------------------------------------
recorder Node -file $dir/ElasCantiCB_NM.out -time -node $startNode -dof 1 2 3 4 5 6 disp;# record displacements at the middle node
# define second stage main Load (Axial force at the two ends)
#------------------------------------------------------------- 
set N 1000.0;
pattern Plain 2 Linear {
  # NodeID, Fx, Fy, Fz, Mx, My, Mz
  load $startNode $N 0 0 0 [expr -$N*$zc] 0;
 }
