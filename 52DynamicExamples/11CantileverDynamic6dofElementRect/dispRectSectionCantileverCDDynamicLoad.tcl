...
# create load pattern
set WindSeriesA "Series -dt 0.01 -filePath WindForceA100.txt -factor 1";	# define acceleration vector from file (dt=0.01 is associated with the input file gm)
...
pattern Plain 3 $WindSeriesA -fact 1 {
	load $EndNode  0.0 0.0 [expr 1.0*$lbf] 0.0 0.0 0.0;
}
...
analyze 3430 0.000000001;					# Central Difference
#analyze 3438 1;
