...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/mixed6dofCantileverDispNR.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/mixed6dofCantileverReacNR.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
...
integrator LoadControl 0.00000001;
