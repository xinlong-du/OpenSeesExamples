...
for {set i 101} {$i<142} {incr i 1} {
	node $i [expr -0.125+0.125*($i-100)] -0.47368 0.0;
}
...
rigidLink beam $EndNode $EndLoad;
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB40rigidLink.out -time -node $EndCentroid -dof 1 2 3 4 5 6 disp;			# displacements of end node
