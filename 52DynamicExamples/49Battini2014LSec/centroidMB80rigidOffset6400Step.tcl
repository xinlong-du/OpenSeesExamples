...
element mixedBeamColumn 81 $MiddleNode $MiddleLoad $numIntgrPts $ColSecTag2 $IDColTransf2 -shearCenter $y0 $z0;
element mixedBeamColumn 82 $EndNode $EndLoad $numIntgrPts $ColSecTag2 $IDColTransf2 -shearCenter $y0 $z0;
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/centroidMB80rigidOffset6400Step.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
