...
node 42 2.5 [expr -0.054819277108434-0.009] [expr -0.029819277108434-0.009];
node 43 5.0 [expr -0.054819277108434-0.009] [expr -0.029819277108434-0.009];
...
element dispBeamColumn 41 $MiddleNode $MiddleLoad $numIntgrPts $ColSecTag2 $IDColTransf2 $y0 $z0;
element dispBeamColumn 42 $EndNode $EndLoad $numIntgrPts $ColSecTag2 $IDColTransf2 $y0 $z0;
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/centroidDB40rigidOffset6400Step.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
