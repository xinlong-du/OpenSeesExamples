...
geomTransf $ColTransfType  $IDColTransf 0 0 1 -jntOffset 0.0 0.047368 0.0 0.0 0.047368 0.0;	#define geometric transformation: performs a corotational geometric transformation
...
geomTransf $ColTransfType $IDColTransf2 0 0 1;
element dispBeamColumn $EndNode $EndNode $EndLoad $numIntgrPts $ColSecTag2 $IDColTransf2 $y0 $z0;
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB80EndNodeRigidBattini.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
