...
element dispBeamColumn $EndNode $EndNode $EndLoad $numIntgrPts $ColSecTag2 $IDColTransf2 $y0 $z0;
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB80EndNodeRigid.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
