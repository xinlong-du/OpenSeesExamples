...
element dispBeamColumn $EndNode $EndNode $Centroid $numIntgrPts $ColSecTag $IDColTransf2 $y0 $z0;
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB40EndNode.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
