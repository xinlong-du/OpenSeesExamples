...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB40Centroid.out -time -node $Centroid -dof 1 2 3 4 5 6 disp;			# displacements of end node
...
pattern Plain 3 $WindSeriesA -fact 1000 {
	load $EndNode  0.0 25.0 50.0 0.0 0.0 0.0;  
}
