...
geomTransf $ColTransfType  $IDColTransf 0 0 1 -jntOffset 0.0 0.0 -0.046474 0.0 0.0 -0.046474;	#define geometric transformation: performs a corotational geometric transformation
...
set nodeI $i
set nodeJ [expr $i+1]
element dispBeamColumn $elemID $nodeI $nodeJ $numIntgrPts $ColSecTag $IDColTransf $y0 $z0 -mass 59.66;	
}
set IDColTransf2 200; 
geomTransf $ColTransfType $IDColTransf2 0 1 0;
element dispBeamColumn $EndNode $EndNode $Centroid $numIntgrPts $ColSecTag2 $IDColTransf2 $y0 $z0;
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB40EndNodeRigidHsiaoSC.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
...
pattern Plain 3 $WindSeriesA -fact 1000 {
	load $Centroid 0.0 25.0 50.0 0.0 0.0 0.0;  
}
