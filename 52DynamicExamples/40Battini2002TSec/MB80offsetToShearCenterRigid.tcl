...
geomTransf $ColTransfType  $IDColTransf 0 0 1 -jntOffset 0.0 0.0 -0.047368 0.0 0.0 -0.047368;	#define geometric transformation: performs a corotational geometric transformation
...
set nodeI $i
set nodeJ [expr $i+1]
element mixedBeamColumn $elemID $nodeI $nodeJ $numIntgrPts $ColSecTag $IDColTransf -shearCenter $y0 $z0 -mass 59.66;	
}
set IDColTransf2 200; 
geomTransf $ColTransfType $IDColTransf2 0 1 0;
element mixedBeamColumn $EndNode $EndNode $EndLoad $numIntgrPts $ColSecTag2 $IDColTransf2 -shearCenter $y0 $z0;
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/MB80EndNodeRigid.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
...
pattern Plain 3 $WindSeriesA -fact 1000 {
	load $EndLoad 0.0 25.0 50.0 0.0 0.0 0.0;  
}
