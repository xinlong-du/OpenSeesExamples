...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/centroidDB40Mass40.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
...
pattern Plain 3 $WindSeriesA -fact 1000 {
	load $EndNode  0.0 -10.0 5.0 0.0 0.0 0.0;   
}
