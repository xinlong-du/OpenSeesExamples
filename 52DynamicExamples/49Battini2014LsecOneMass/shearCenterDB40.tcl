...
mass $EndNode 149.15 149.15 149.15 0.0 0.0 0.0;
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB40.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
...
pattern Plain 3 $WindSeriesA -fact 1000 {
	load $EndNode  0.0 -5.0 2.5 0.0 0.0 0.0;   
}
