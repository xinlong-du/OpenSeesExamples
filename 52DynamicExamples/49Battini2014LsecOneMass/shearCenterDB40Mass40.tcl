...
#set up mass
mass $StartNode 2.931975 2.931975 2.931975 0.0 0.0 0.0;
  mass $EndNode 2.931975 2.931975 2.931975 0.0 0.0 0.0;
for {set i [expr $StartNode+1]} {$i<$EndNode} {incr i 1} {
mass $i 5.86395 5.86395 5.86395 0.0 0.0 0.0;	
}
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/DB40Mass40.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of end node
