...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/SimsupDispImprfShortShcenter.out -time -node $MiddleNode $StartNode $EndNode -dof 1 2 3 4 5 6 7 disp;			# displacements of middle node
recorder Node -file $dataDir/SimsupReacImprfShortShcenter.out -time -node $StartNode $EndNode -dof 1 2 3 4 5 6 7 reaction;		# support reaction
