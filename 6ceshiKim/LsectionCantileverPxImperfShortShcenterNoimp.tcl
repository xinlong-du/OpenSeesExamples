...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/CantileverDispImprfShortShcenterNoimp.out -time -node $EndNode -dof 1 2 3 4 5 6 7 disp;			# displacements of middle node
recorder Node -file $dataDir/CantileverReacImprfShortShcenterNoimp.out -time -node $StartNode -dof 1 2 3 4 5 6 7 reaction;		# support reaction
