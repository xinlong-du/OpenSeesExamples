...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/SimsupDispImprfShortShcenterRotctrl.out -time -node $MiddleNode $StartNode $EndNode -dof 1 2 3 4 5 6 7 disp;			# displacements of middle node
recorder Node -file $dataDir/SimsupReacImprfShortShcenterRotctrl.out -time -node $StartNode $EndNode -dof 1 2 3 4 5 6 7 reaction;		# support reaction
...
pattern Plain 1 Linear {
  ...
  load $MiddleNode 0 0 0 0.0043 0 0 0;
  }
...
#set Dmax 10;
set IDctrlNode $MiddleNode; # node where displacement is read for displacement control
set IDctrlDOF 4;            # degree of freedom of displacement read for displacement control
