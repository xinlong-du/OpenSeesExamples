...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/CantileverDispImprf.out -time -node $EndNode -dof 1 2 3 4 5 6 7 disp;			# displacements of middle node
recorder Node -file $dataDir/CantileverReacImprf.out -time -node $StartNode -dof 1 2 3 4 5 6 7 reaction;		# support reaction
