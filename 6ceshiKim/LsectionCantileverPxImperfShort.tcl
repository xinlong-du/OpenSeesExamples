...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/CantileverDispImprfShort.out -time -node $EndNode -dof 1 2 3 4 5 6 7 disp;			# displacements of middle node
recorder Node -file $dataDir/CantileverReacImprfShort.out -time -node $StartNode -dof 1 2 3 4 5 6 7 reaction;		# support reaction
