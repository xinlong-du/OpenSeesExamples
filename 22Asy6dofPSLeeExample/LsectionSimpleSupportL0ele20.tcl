...
set SecTagTorsion 70
	...
	set Fy 250000000;
	set Es 200000000000;		# Steel Young's Modulus
	set nu 0.3;
	set Gs [expr $Es/2./[expr 1+$nu]];  # Torsional stiffness Modulus
	set Hiso 0.1;
	set Hkin 0.0;
	set matID 1;
	uniaxialMaterial Hardening $matID $Es $Fy $Hiso $Hkin;
	# ELEMENT properties
...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/LsectionSimpDispL0ele20.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/LsectionSimpReacL0ele20.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
