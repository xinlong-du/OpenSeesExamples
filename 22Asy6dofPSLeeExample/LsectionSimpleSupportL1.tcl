...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/LsectionSimpDispL1.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/LsectionSimpDispL1M.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
recorder Node -file $dataDir/LsectionSimpReacL1.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
...
algorithm Newton;
set Dincr -0.000000001; #-0.00002
#integrator LoadControl 0.0001
#integrator ArcLength 0.005 1.0; #arclength alpha
                               #Node,  dof, 1st incr, Jd, min,   max
integrator DisplacementControl $EndNode 1   $Dincr     1  $Dincr -0.00000001;
