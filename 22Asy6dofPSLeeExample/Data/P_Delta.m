clear;clc;
DispL0ele10=load('LsectionSimpDispL0ele10.out');
DispL0ele20=load('LsectionSimpDispL0ele20.out');
...
hold on
plot(-DispL0ele10(:,2),40000*DispL0ele10(:,1))
plot(-DispL0ele20(:,2),40000*DispL0ele20(:,1))
legend('Lee','ele10','ele20')
xlim([0 0.0012])
ylim([0 48000])
xlabel('m') 
ylabel('N')
