...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/np4InElasDispEndDB40.out.$pid -time -node 41 -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/np4InElasDispMidDB40.out.$pid -time -node 21 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
...
integrator ParallelDisplacementControl 41      1   $Dincr     1  $Dincr -0.01;
