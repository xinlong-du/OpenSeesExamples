...
# Define RECORDERS -------------------------------------------------------------
recorder Node -xml $dataDir/CantileverDispModifyFiber2layerDB6.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -xml $dataDir/CantileverReacModifyFIber2layerDB6.out -time -node $StartNode -dof 1 2 3 4 5 6 reaction;		# support reaction
