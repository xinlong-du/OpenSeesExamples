...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/InElasDispEndMB40.out -time -node 41 -dof 1 2 3 4 5 6 disp;			# displacements of end node
recorder Node -file $dataDir/InElasDispMidMB40.out -time -node 21 -dof 1 2 3 4 5 6 disp;			# displacements of middle node
