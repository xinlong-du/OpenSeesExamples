...
plot(InElasDispMidMB40(:,3),InElasDispMidMB40(:,1),'r--','LineWidth',1)
xlim([0 60])
ylim([1 2.8])
...
legend({'Battini and Pacoste [32]','DB40','MB40'},'FontSize',10)
