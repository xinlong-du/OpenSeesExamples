# --------------------------------------------------------------------------------------------------
# Example 6. 2D Frame --  Multiple-Support Sine-Wave ground motion
#                                Silvia Mazzoni & Frank McKenna, 2006
# execute this file after you have built the model, and after you apply gravity
#

# MultipleSupport Sine-Wave ground motion (different displacement input at spec'd support nodes) 
# iSupportNode is defined with the model;	# support nodes where ground motions are input, for multiple-support excitation
