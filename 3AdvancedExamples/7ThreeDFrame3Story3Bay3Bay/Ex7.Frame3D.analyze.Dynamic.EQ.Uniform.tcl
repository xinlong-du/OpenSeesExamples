# --------------------------------------------------------------------------------------------------
# Example 7. Uniform Earthquake Excitation
...
recorder plot $dataDir/DFree.out DisplDOF$GMdirection 1200 10 400 400 -columns 1 2; # a window to plot the nodal displacements versus time
