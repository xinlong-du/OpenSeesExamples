# --------------------------------------------------------------------------------------------------
# Example 7. Multiple-Support Sine-Wave Excitation
#                                Silvia Mazzoni & Frank McKenna, 2006
# execute this file after you have built the model, and after you apply gravity
#

# MultipleSupport Sine-Wave ground motion (different displacement input at spec'd support nodes) 
# - support Nodes: 111 112 211 212;	# support nodes where ground motions are input, for multiple-support excitation
...
set ViewScale 3;	# scaling factor for viewing deformed shape, it depends on the dimensions of the model
DisplayModel3D DeformedShape $ViewScale $xLoc1 $yLoc1  $xPixels $yPixels
recorder plot $dataDir/DFree.out Displ-1 1200 10 400 400 -columns 1 2; # a window to plot the nodal displacements versus time
