...
set iDmax "0.005  0.01 0.03 0.05 0.1";	# vector of displacement-cycle peaks, in terms of storey drift ratio
set Fact $LBuilding ;			# scale drift ratio by storey height for displacement cycles
set Dincr [expr 0.0001*$LBuilding ];	# displacement increment for pushover. you want this to be very small, but not too small to slow analysis
