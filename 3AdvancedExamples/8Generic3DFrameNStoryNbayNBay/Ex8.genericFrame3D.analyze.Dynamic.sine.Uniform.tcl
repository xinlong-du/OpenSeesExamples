# --------------------------------------------------------------------------------------------------
# Example 8. Uniform Sine-Wave Acceleration input
...
set TPeriodSine [expr 0.75*$sec];		# period of input sine wave
set DurationSine [expr 5*$TPeriodSine];		# duration of input sine wave

# Define DISPLAY -------------------------------------------------------------
# the deformed shape is defined in the build file
recorder plot $dataDir/DFree.out Displ-X 1200 10 300 300 -columns 1 2 ; # a window to plot the nodal displacements versus time
recorder plot $dataDir/DFree.out Displ-Z 1200 310 300 300 -columns 1 4 ; # a window to plot the nodal displacements versus time
