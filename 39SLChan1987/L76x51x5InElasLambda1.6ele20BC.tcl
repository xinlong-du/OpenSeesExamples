...
# Define RECORDERS -------------------------------------------------------------
recorder Node -file $dataDir/L76x51x5InElasLambda16End20eleBC.out -time -node $EndNode -dof 1 2 3 4 5 6 disp;			# displacements of middle node
recorder Node -file $dataDir/L76x51x5InElasLambda16Sat20eleBC.out -time -node $StartNode -dof 1 2 3 4 5 6 disp;		# support reaction
recorder Node -file $dataDir/L76x51x5InElasLambda16Mid20eleBC.out -time -node $MiddleNode -dof 1 2 3 4 5 6 disp;
# Define DISPLAY -------------------------------------------------------------
